    ...
    <section id="about-me" className="py-20 px-10 bg-white">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          <div className="w-full aspect-square max-w-[400px] mx-auto bg-white border-4 border-black shadow-[8px_8px_0_var(--color-black)] flex items-center justify-center">
        ...
        <div>
          ...
          <div className="bg-white border-3 border-black p-6 shadow-[5px_5px_0_var(--color-black)] mb-6">
            <p className="text-base leading-relaxed text-gray-700 mb-4">
              ...
              digital products that make an impact. I specialize in creating performant, 
