...
export function EducationSection() {
  return (
    <section
      id="education"
      className="pb-10 pt-4 px-4 md:px-10 md:h-[110dvh] relative"
    >
      <h2
      ...
      <div
        className="flex flex-col gap-6 border-y-2 pt-4 px-2 md:h-[90dvh] h-[60dvh]"
        style={{ overflowY: "auto" }}
      >
        {education.map((edu: EducationType, idx: number) => (
          <div
            key={edu.title + edu.institution + idx}
            className="bg-white border-2 border-blue-500 p-4 shadow-[4px_4px_0_var(--color-black)] rounded-lg flex items-start gap-4"
          >
