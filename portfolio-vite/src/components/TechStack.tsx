    ...
    >
      ...
      <div className="relative max-w-full md:max-w-350 mx-auto px-2 sm:px-4">
        ...
        <div className="flex items-center justify-between mb-10">
          <h2
            className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight break-words leading-tight max-w-full"
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8">
            {stack.map((item, index) => (
              ...
              >
                ...
                <span
                  className="text-base sm:text-xl font-extrabold tracking-wide break-words max-w-full"
                  style={{ wordBreak: "break-word" }}
                >
                  {item.name}
                </span>
