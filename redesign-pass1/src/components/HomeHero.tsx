      ...
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-16 items-center relative">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            . I build AI automations, MVPs, and dig into the systems
            underneath &mdash; Go, databases, and the occasional weekend
            project that has no business being this deep.
          </p>
